...
#
# loadd(c(bs_coeffs_tab, parameter_categories, permutation_results_w_pval), cache = drake_cache)
#
# ----------------------------------------------------------------
#  RUN PERMUTATION TEST TO TEST SHARP NULL
# ----------------------------------------------------------------
plot_burned_structure_coeffs_rand_plot <- function(bs_coeffs_tab, parameter_categories, permutation_results_w_pval,

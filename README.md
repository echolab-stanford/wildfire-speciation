...
## Organization
Results from the paper are in the Dropbox folder called figures. All main text and supplementary figurees are in the folder. Code to replicate results are in the scripts folder. Data are in Dropbox.
